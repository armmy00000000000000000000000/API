...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-navy-primary bg-navy elevation-4 sidebar-no-expand">
        ...
        <h5 class="brand-text font-weight-light">icandefine</h5>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=expense" class="nav-link nav-balance">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=balance" class="nav-link ">
                      <i class="nav-icon fas fa-file"></i>

                        <p>
                          <!-- Expense Management -->จัดการงบดุล
                        </p>
                      </a>
                    </li>
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=retire" class="nav-link ">
                      <i class="nav-icon fas fa-file"></i>

                        <p>
                          <!-- Expense Management -->แผนเกษียณ
                        </p>
                      </a>
                    </li>
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=savings" class="nav-link ">
                      <i class="nav-icon fas fa-file"></i>

                        <p>
                          <!-- Expense Management -->แผนการออม
                        </p>
                      </a>
                    </li>
